            ...
            return (
                ...
                (w.prototype.setDownloadValue = function (t) {
                    if (this.settings.download) {
                        ...
                        var src = e.downloadUrl !== false &&
                            (e.downloadUrl || e.src);
                        if (src && !e.iframe) {
                            this.getElementById('lg-download').attr('href', "");
                            this.getElementById('lg-download').attr('download', src);
                        }
                        // if (!1 === e.downloadUrl || "false" === e.downloadUrl) this.outer.addClass("lg-hide-download");
                        // else {
                        //     var i = this.getElementById("lg-download");
                        //     this.outer.removeClass("lg-hide-download"), i.attr("href", ""), i.attr("download", e.downloadUrl || e.src), e.download && i.attr("download", e.download);
                        // }
                    }
                }),
